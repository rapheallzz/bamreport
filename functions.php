...
if ( ! function_exists( 'gunter_scripts' ) ) {
	function gunter_scripts() {
		...
		if( $is_minify == true ):
			wp_enqueue_style( 'gunter-main-style', get_template_directory_uri() . '/assets/css/gunter-style.min.css');
			wp_enqueue_style( 'gunter-responsive', get_template_directory_uri() . '/assets/css/responsive.min.css');
		else :
			wp_enqueue_style( 'gunter-main-style', get_template_directory_uri() . '/assets/css/gunter-style.css');
			wp_enqueue_style( 'gunter-responsive', get_template_directory_uri() . '/assets/css/responsive.css');
		endif;
		...
		wp_enqueue_script( 'jquery-ajaxchimp', get_template_directory_uri() . '/assets/js/jquery.ajaxchimp.min.js', array ( 'jquery' ), true);

		// Smartify JS 
		if( $is_lazyloader == true ):
			wp_enqueue_script( 'jquery-smartify', get_template_directory_uri() . '/assets/js/jquery.smartify.js', array( 'jquery' ), false, true );
			wp_enqueue_script( 'gunter-smartify', get_template_directory_uri() . '/assets/js/smartify.js', array( 'jquery' ), false, true );
		endif;

		if( $is_minify == true ):
			wp_enqueue_script( 'gunter-active', get_template_directory_uri() . '/assets/js/active.min.js', array( 'jquery' ), false, true );
		else :
			wp_enqueue_script( 'gunter-active', get_template_directory_uri() . '/assets/js/active.js', array( 'jquery' ), false, true );
		endif;
...
add_action( 'admin_enqueue_scripts', function() {
    global $pagenow;
    wp_enqueue_script( 'gunter-admin', get_template_directory_uri() .'/assets/js/gunter-admin.js', array('jquery'), '1.0.0', true );
    if ( $pagenow == 'admin.php' ) {
        wp_enqueue_style( 'gunter-admin-dashboard', get_template_directory_uri() .'/assets/css/admin-dashboard.min.css' );
    }
});
