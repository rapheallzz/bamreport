        ...
        <div class="products-image">
            ...
            <ul class="product-btn-hover">
                <li class="product-link">
                    <a  href="#modal-center<?php echo esc_attr(get_the_ID(),'gunter');?>" uk-toggle><i class="fa fa-eye"></i></a>
                </li>
...
<div id="modal-center<?php echo esc_attr(get_the_ID(),'gunter');?>" class="uk-flex-top" uk-modal>
