...
if ( ! function_exists( 'gunter_custom_css' ) ) {
    function gunter_custom_css(){
        wp_enqueue_style('gunter_custom_style', get_template_directory_uri() . '/assets/css/custom-style.css');
        global $opt_name;
                ...
                $preloader_image = isset( $opt_name['preloader_image']['url'] ) ? $opt_name['preloader_image']['url'] : get_template_directory_uri() . '/assets/img' .'/status.gif';
                ...
                // Custom Js
                wp_enqueue_script( 'gunter-custom-script', get_template_directory_uri() . '/assets/js/gunter-custom-script.js', array( 'jquery' ), false, true );
                $custom_script ='';
